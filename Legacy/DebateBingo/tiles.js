...
var vance_vs_walz = [
    "Couches Mentioned",
    "Hatian Immigrants mentioned",
    "Walz says something dad-ish (Fixing a Car, Sports Metaphor, etc)",
    "'Cats and Dogs'",
    "'Project 2025'",
    "JD looks like he has extra eye liner on",
    "JDs book 'Hillbilly Elegy' mentioned",
    "'Free School Lunches' mentioned",
    "Minnesota Riots Mentioned",
    "'Stolen Valor'",
    "Attack on running mate",
    "IVF Mentioned",
    "'Cat Ladies'",
    "Price of eggs mentioned",
    "Huricane Helene mentioned",
    "Walz calls JD weird",
    "JD is called Elitist",
    "JD makes something up or admits to making something up",
    "Vance calling Trump Hitler is mentioned.",
];
